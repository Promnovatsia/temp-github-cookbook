...
MenuService.$inject = ['$resource', 'RequestService'];

function MenuService($resource, RequestService) {
    ...
    function getRequests(menu) {
        return RequestService.requestByMenu(
            {
                menuId: menu.id
            }
        ).$promise;
